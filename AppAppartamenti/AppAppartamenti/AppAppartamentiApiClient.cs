...
namespace AppAppartamentiApiClient
{
    ...
    public partial class AnnunciClient
    {
        ...
        public async System.Threading.Tasks.Task<AnnuncioDtoInput> InsertAnnuncioAsync(AnnuncioDtoInput annuncio, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var stringContent = Newtonsoft.Json.JsonConvert.SerializeObject(annuncio, _settings.Value);
    ...
    public partial class MessaggiClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<int> GetChatMessagesToReadAsync()
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<int> GetChatMessagesToReadAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
