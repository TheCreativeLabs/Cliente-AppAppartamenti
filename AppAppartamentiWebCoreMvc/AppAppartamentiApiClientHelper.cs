...
namespace AppAppartamenti.Api
{
    public static class ApiHelper
    {
        ...
        /// <returns></returns>
        public static async Task<BearerToken> SetTokenAsync(string ApiEndpoint, string Username, string Password)
        {
            BearerToken bearerToken = new BearerToken();
            using (var httpClient = new HttpClient())
            {
                Uri Endpoint = new Uri($"{ApiEndpoint}Token");
                ...
                if (response != null && response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    bearerToken = JsonConvert.DeserializeObject<BearerToken>(jsonResponse);
