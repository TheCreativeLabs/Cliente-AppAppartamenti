...
namespace AppAppartamentiWebCoreMvc.AppAppartamentiApiClient
{
    ...
    public partial class AccountClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AvatarDtoOutput>> GetAllAvatarAsync()
        {
            return GetAllAvatarAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AvatarDtoOutput>> GetAllAvatarAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Account/AllAvatar");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<AvatarDtoOutput>>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        ...
                        return default(System.Collections.Generic.ICollection<AvatarDtoOutput>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<object> UpdateAvatarCurrentUserAsync(System.Guid idAvatar)
        {
            return UpdateAvatarCurrentUserAsync(idAvatar, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<object> UpdateAvatarCurrentUserAsync(System.Guid idAvatar, System.Threading.CancellationToken cancellationToken)
        {
            if (idAvatar == null)
                throw new System.ArgumentNullException("idAvatar");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Account/UpdateAvatarCurrentUsere/{IdAvatar}");
            urlBuilder_.Replace("{IdAvatar}", System.Uri.EscapeDataString(ConvertToString(idAvatar, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class AdminClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TipologiaDocumento>> GetListaTipologiaDocumentoAsync()
        {
            return GetListaTipologiaDocumentoAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TipologiaDocumento>> GetListaTipologiaDocumentoAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Admin/ListaTipologiaDocumento");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TipologiaDocumento>>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        ...
                        return default(System.Collections.Generic.ICollection<TipologiaDocumento>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.24.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class AvatarDtoOutput
    {
        ...
        [Newtonsoft.Json.JsonProperty("isAvatarOfCurrentUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? IsAvatarOfCurrentUser { get; set; }
    ...
    public partial class TipologiaDocumento
    {
        ...
        [Newtonsoft.Json.JsonProperty("Documento", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Documento> Documento { get; set; }
    ...
    public partial class Documento
    {
        ...
        [Newtonsoft.Json.JsonProperty("DocumentoPdf", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public byte[] DocumentoPdf { get; set; }

        [Newtonsoft.Json.JsonProperty("TipologiaDocumento", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TipologiaDocumento TipologiaDocumento { get; set; }
